...
#define FD_TOPO_WKSP_KIND_ARCHIVE      (27UL)
#define FD_TOPO_WKSP_KIND_MAX          ( FD_TOPO_WKSP_KIND_ARCHIVE+1 ) /* Keep updated with maximum tile IDX */
...
#define FD_TOPO_TILE_KIND_ARCHIVE (12UL)
#define FD_TOPO_TILE_KIND_MAX     ( FD_TOPO_TILE_KIND_ARCHIVE+1 ) /* Keep updated with maximum tile IDX */
...
fd_topo_wksp_kind_str( ulong kind ) {
  switch( kind ) {
    ...
    case FD_TOPO_WKSP_KIND_ARCHIVE:      return "archive";
...
fd_topo_tile_kind_str( ulong kind ) {
  switch ( kind ) {
     ...
     case FD_TOPO_TILE_KIND_ARCHIVE: return "archive";
